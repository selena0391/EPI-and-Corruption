...
from each of them.
cpi dataframe contains list of countries, their Environment Performance Indeces and various scores that indicate air health, water health, forestries, etc
...
In order to find connections between corruption and environmental health one needs a more comprehensive data set. I wish the dataset had some kind of corruption scores on each country's biggest industries. Various industries could directly lead to deforestation or water pollution and so on. I would like to gather more information on that.
